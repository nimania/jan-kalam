...
RULES: list[tuple[str, str, str, list[str]]] = [
    ...
    ("environment", "محیط زیست", "Environment",
     ["محیط زیست", "آلودگی هوا", "خشکسالی", "ریزگرد", "گرمایش زمین", "تغییر اقلیم",
      "جنگل", "تالاب", "بحران آب", "زلزله", "سیل",
      "environment", "climate", "pollution", "drought", "wildfire", "emission",
      "carbon", "biodiversity", "earthquake", "flood"]),
    ("health", "سلامت", "Health",
     ["سلامت", "بیماری", "واکسن", "بهداشت", "بیمارستان", "دارو", "پزشک", "شیوع",
      "health", "disease", "vaccine", "hospital", "medicine", "outbreak", "virus"]),
    ("culture", "فرهنگ و هنر", "Culture",
     ["سینما", "فیلم", "موسیقی", "کتاب", "هنر", "جشنواره", "تئاتر", "کنسرت",
      "cinema", "film", "music", "book", "festival", "theater", "concert", "art"]),
